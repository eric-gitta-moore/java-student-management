...
public class SysUserController {
    ...
    public Result<List<String>> queryUserRole(@RequestParam(name = "userid", required = true) String userid) {
        ...
        List<SysUserRole> userRole = sysUserRoleService.list(
...
//                json.put("avatar", item.getSysUser().getAvatar());
    ...
    public Result<SysUserDepart> deleteUserInDepart(@RequestParam(name = "depId") String depId,
        ...
        try {
            ...
            if (b) {
                List<SysDepartRole> sysDepartRoleList = departRoleService.list(
...
//	}
    ...
    public Result<SysUser> passwordChange(@RequestParam(name = "username") String username,
        ...
        if (sysUser == null) {
            ...
            baseCommonService.addLog("重置 " + username + " 的密码，操作人： " + sysUser.getUsername(),
                CommonConstant.LOG_TYPE_2, 2);
